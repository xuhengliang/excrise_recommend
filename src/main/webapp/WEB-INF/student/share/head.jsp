...
<div class="head">
	<div class="head_logo">
		<img src="images/logo.png"> <span class="logo_content">欢迎使用HL考试系统</span>
	</div>
	<!--显示登录的用户-->
	<div class="head_info">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li><a href="student/recommend/auto-recommend">个性化推荐习题</a></li>
					<li><a href="student/knowledge/list">知识点列表</a></li>
